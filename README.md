...
```
JavaArray data = Wrapper.getStatus();
```
...
```
String playerUUID = Wrapper.getPlayerUUID(String playerName);
```
or
```
String playerUUID = Wrapper.getPlayerUUID(String playerName, long timestamp);
```
...
```
String playerName = Wrapper.getPlayerName(String playerUUID);
```
or
```
String playerName = Wrapper.getPlayerName(String playerUUID, long timestamp);
```
### Name History
...
```
JsonArray data = Wrapper.getNameHistory(String playerUUID);
```
## Examples
...
public class main {
    public static void main(String[] args){
        JsonArray status = Wrapper.getStatus();

        String uuidAtTime = Wrapper.getPlayerUUID("playerName", UNIXTime);

        String uuid = Wrapper.getPlayerUUID("playerName");

        String name = Wrapper.getPlayerName("yourUUID");

        String nameAtTime = Wrapper.getPlayerName("yourUUID", UNIXTime);
        
        JsonArray data = Wrapper.getNameHistory("yourUUID");
